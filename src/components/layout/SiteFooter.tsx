...
const FACEBOOK_URL = "https://www.facebook.com/share/1EBsXWNqQz/";
            ...
            <div className="flex gap-3">
              {[
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label={label}
                  className={`flex h-11 w-11 items-center justify-center rounded-full bg-white/10 text-white transition-all hover:scale-110 hover:shadow-[0_0_16px_rgba(56,189,248,0.6)] ${hover}`}
                >
                  <Icon size={20} />
                </a>
              ))}
